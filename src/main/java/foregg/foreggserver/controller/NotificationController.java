...
public class NotificationController {
    ...
    @GetMapping("/history")
    public ApiResponse<NotificationResponseDTO> getNotificationHistory(@RequestParam(name = "page") int page) {
        NotificationResponseDTO result = notificationQueryService.getNotificationHistory(page);
